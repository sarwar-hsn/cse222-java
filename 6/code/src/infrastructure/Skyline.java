...
public class Skyline {
	...
	private BuildingsArray buildings;
	char[][] display;
	
	
	/**
	 * 
	 * @param buildings is of BuildingsArray type
	 */
	public Skyline(BuildingsArray buildings) {
    ...
    private void add(Point st){
    	...
    	if (index > 0 && pointsArray[index - 1].left == st.left) {
    		pointsArray[index - 1].height = Math.max(pointsArray[index - 1].height, st.left);
            return;
        }
    ...
    */
    private  Skyline findSkyline(BuildingsArray arr, int l, int h){
