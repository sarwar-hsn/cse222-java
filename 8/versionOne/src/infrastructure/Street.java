...
public class Street {
	private int length;
	private ArrayList<Building> leftSide;
	private ArrayList<Building> rightSide;
	...
	public Street(int length) {
		this.length = length;
		this.leftSide = new ArrayList<Building>();
		this.rightSide = new ArrayList<Building>();
	...
	/**
	 * 
	 * @return returns a {@link ArrayList} of {@link Building}
	 */
	public ArrayList<Building> left() {
	...
	/**
	 * 
	 * @return returns @return returns a {@link ArrayList} of {@link Building}
	 */
	public ArrayList<Building> right() {
