...
public class Skyline {
	...
	private LDLinkedList<Building> buildings;
	char[][] display;
	
	
	/**
	 * 
	 * @param buildings is  {@link LDLinkedList} {@link Building}
	 */
	public Skyline(LDLinkedList<Building> buildings) {
    ...
    */
    private  Skyline findSkyline(LDLinkedList<Building> arr, int l, int h){
