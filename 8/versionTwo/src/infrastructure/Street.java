...
public class Street {
	private int length;
	private LinkedList<Building> leftSide;
	private LinkedList<Building> rightSide;
	...
	public Street(int length) {
		this.length = length;
		this.leftSide = new LinkedList<Building>();
		this.rightSide = new LinkedList<Building>();
	...
	/**
	 * 
	 * @return returns a {@link LinkedList} of {@link Building}
	 */
	public LinkedList<Building> left() {
	...
	/**
	 * 
	 * @return returns @return returns a {@link LinkedList} of {@link Building}
	 */
	public LinkedList<Building> right() {
